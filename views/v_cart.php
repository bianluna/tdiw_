...
<button class="button" onclick="(() => {window.location.href = '../index.php';})();" id="back-shop-button">Volver a la
    tienda</button>
        ...
        <?php foreach ($books_in_cart as $product): ?>
            <div class="card">
                ...
                <div class="card-bottom">
                    <a href="#" onclick="fetchBookDetails(event)" class="card-title"
                        id="<?= htmlentities($product['book_id']) ?>"
                ...
                <div>
                    ...
                    <input type="text" id="quantity" style="width:50px;" value="<?= htmlentities($product['quantity']) ?>"
                        readonly>
                    <button class="button-quantity" style="width:50px;">+</button>
                </div>
                <div>
                    <button class="remove-button" onclick="removeFromCart(<?= htmlentities($product['book_id']) ?>)">
                        &times;
                    </button>
                </div>
            </div>
